...
WebUI.verifyElementText(findTestObject('Object Repository/Web/Order/Page_frontend-web/h3_AltaShop'), 'AltaShop')
...
WebUI.verifyElementText(findTestObject('Object Repository/Web/Order/Page_frontend-web/div_Login'), 'Login')
