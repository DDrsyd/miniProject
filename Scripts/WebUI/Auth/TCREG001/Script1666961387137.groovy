...
WebUI.setText(findTestObject('Object Repository/Web/Page_frontend-web/input_Nama Lengkap_input-301'), 'did')

WebUI.setText(findTestObject('Object Repository/Web/Page_frontend-web/input_Email_input-304'), 'did@gmail.com')

WebUI.setText(findTestObject('Object Repository/Web/Page_frontend-web/input_Password_input-307'), 'did123')
